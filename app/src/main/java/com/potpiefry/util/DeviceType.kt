...
enum class DeviceType { Tablet, Phone }
...
fun rememberDeviceType(): DeviceType {
	...
	if ((windowSize.width == WindowType.Medium || windowSize.width == WindowType.Expanded) &&
		windowSize.height == WindowType.Medium || windowSize.height == WindowType.Expanded
	)
